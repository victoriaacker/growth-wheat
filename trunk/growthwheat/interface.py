...
def run(g, dt, geometrical_model, copy=True):
    ...
    growthwheat_hgzs_outputs, growthwheat_elements_outputs = converter.to_dataframes(simulation_.outputs)
    # return the updated MTG
    return g, growthwheat_hgzs_outputs, growthwheat_elements_outputs
